...
class ProfileRedirictionSearch extends StatefulWidget {
  final String userId ;
  const ProfileRedirictionSearch({super.key, required this.userId});

  @override
  State<ProfileRedirictionSearch> createState() => _ProfilPageSecond();
}

class _ProfilPageSecond extends State<ProfileRedirictionSearch> {
